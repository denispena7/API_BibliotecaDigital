...
import es.library.springboot.controllers.api.LoanApi;
...
//	}
			...
			@RequestBody LoanRequestDTO prestamo)
	{
        ...
        return created(nuevoPrestamo, "Loan created");
	}
...
//	}
			...
			@RequestBody LoanUptRequestDTO prestamo)
	{
		...
		return ok(prestamoAct, "Loan state updated");
	}
