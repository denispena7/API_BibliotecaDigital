...
public class GlobalExceptionHandler
{
    ...
    public ResponseEntity<WraperResponse<?>> methodNotSupported(HttpRequestMethodNotSupportedException e)
    {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(new WraperResponse<>(null, false, "Http Request method not supported. Check your request structure"));
    }
    ...
    public ResponseEntity<WraperResponse<?>> handleMediaType(HttpMediaTypeNotSupportedException e) {
        return ResponseEntity.status(HttpStatus.UNSUPPORTED_MEDIA_TYPE)
                .body(new WraperResponse<>(
                        null,
                        false,
                        "Invalid content type. Use multipart/form-data (a valid image format)"
                ));
    }
    
    @ExceptionHandler(NoResourceFoundException.class)
    public ResponseEntity<WraperResponse<?>> badUrlFormation(NoResourceFoundException e)
    {
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(new WraperResponse<>(null, false, "No resource found for your request. Check your url"));
    }
