...
class LoanRepositoryTest 
{
	...
	@Test
	void findByUsuarioIdUsuario_ShouldReturnTheLoanList() 
	{
		Page<Loan> prestamos = loanRepo.findByUsuarioIdUsuario(1L, pageable);
		assertThat(prestamos).isNotNull();
	}
	
	@Test
	void findByUsuarioIdUsuario_ShouldReturnEmptyList_WhenUserNotExists() 
	{
		Page<Loan> prestamos = loanRepo.findByUsuarioIdUsuario(5L, pageable);
